...
const quizLv1 = [
  {
    ...
    options: ["f'x=3y<sup>2</sup>x | f'y=4x<sup>2</sup>y", "f'x=2y<sup>2</sup>x | f'y=2x<sup>2</sup>y", "f'x=2y<sup>3</sup>x | f'y=2xy", "f'x=2y<sup>2</sup>x | f'y=2xy"],
    correct: "f'x=2y<sup>2</sup>x | f'y=2x<sup>2</sup>y",
  },
  {
    id: "1",
    question: "F(y,x)=x<sup>2</sup>+y<sup>2</sup>",
    options: ["f'x=2x | f'y=2y", "f'x=2x | f'y=2y<sup>2</sup>", "f'x=2x<sup>2</sup> | f'y=2y", "f'x=2x<sup>2</sup> | f'y=2y<sup>2</sup>"],
    correct: "f'x=2x | f'y=2y",
  },
  {
    id: "2",
    question: "F(x,y)=x<sup>2</sup>+y<sup>2</sup>+2y",
    options: ["Fx=2x | fy=2y+2", "Fx=2x<sup>2</sup> | fy=2y-2", "Fx=x<sup>2</sup> | fy=2y<sup>2</sup>+2", "Fx=2x | fy=2y+2x"],
